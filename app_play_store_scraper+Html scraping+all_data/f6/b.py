...
#         "com.apphup.dropbox-cloud-photo-storage",
#         sleep_milliseconds=0, # defaults to 0
#         lang='en', # defaults to 'en'
#         country='us', # defaults to 'us'
#         sort=Sort.NEWEST, # defaults to Sort.MOST_RELEVANT
#     )
a_reviews = AppStore('ca', 'dropbox-cloud-photo-storage', '327630330')
a_reviews.review()
...
# Save data
a_df2.to_csv('reviews_dropbox_ca.csv', index=False)